...
def main(text, model):
    ...
    tf = create_tf_table(text)
    idf = create_idf_table(text)
    ...
    summary = order_sentences(text, key_sentences)
    ...
    # Abstract sentences
    summary = add_connectors_m1(summary, model)
    return summary
...
def add_connectors_m1(sentences, model):
...
def add_connectors_m2(sentences, key_words, model):
